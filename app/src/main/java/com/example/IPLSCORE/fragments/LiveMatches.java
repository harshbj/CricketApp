...
public class LiveMatches extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        new LiveMatches().getData();
        System.out.println("Again Reached Main");
        LiveMatches.fragmentManager = getFragmentManager();
    ...
    public void showScoreBoard(View view) {
        Intent scoreBoard = new Intent(getContext(), Scoreboard.class);
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            try {
                                matchList.addAll(Match.createLiveMatchList(task));
                                LiveMatches.matches = matchList;
                                System.out.println(UpcomingMatches.matches.size());
                                new LiveMatches().setUpMatches();
    ...
    private void setUpMatches() {
        MatchAdapter matchAdapter = new MatchAdapter(LiveMatches.matches);
