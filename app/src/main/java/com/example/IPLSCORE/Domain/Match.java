...
public class Match {
    ...
    public static ArrayList<Match> createUpComingMatchList(Task<QuerySnapshot> matchData) throws JSONException, ParseException {
    ...
    @RequiresApi(api = Build.VERSION_CODES.N)
    public static ArrayList<Match> createFinishedMatchList(Task<QuerySnapshot> matchData) throws JSONException, ParseException {
        ArrayList<Match> matches = new ArrayList<Match>();
        SimpleDateFormat inputFormat = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'");
        SimpleDateFormat outputFormat = new SimpleDateFormat("dd MMMM yyyy");
    ...
    @RequiresApi(api = Build.VERSION_CODES.N)
    public static ArrayList<Match> createLiveMatchList(Task<QuerySnapshot> matchData) throws JSONException, ParseException {
        ArrayList<Match> matches = new ArrayList<Match>();
        SimpleDateFormat inputFormat = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'");
        SimpleDateFormat outputFormat = new SimpleDateFormat("dd MMMM yyyy");
        ...
        for (QueryDocumentSnapshot document : matchData.getResult()) {
            ...
            if(matchMap.get("state").toLowerCase().equals("live")) {
                matches.add(match);
            }
        }
